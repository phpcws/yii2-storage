...
//        $saveTo = \Yii::$app->basePath . '/' . $saveTo;
        $appDir = str_replace('\\','/',\Yii::getAlias("@statics"));
        $saveTo = $appDir .'/'. $saveTo;
        ...
        $accessUrl = \Yii::$app->params['uploadImgUrl'] . '/' . static::getRelativePath(realpath($_SERVER['DOCUMENT_ROOT']), $saveTo);
        return $accessUrl;
    }
